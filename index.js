// JACOB CHRISTIANSEN - CSCI 3308 SOFTWARE DEVELOPMENT - HOMEWORK 4 - FRI @8AM REC.
...
$(document).ready(function(){
	...
	$(document).ready(function(){
		Object.keys(state_info).forEach(function(state) {
			var url = 'https://api.darksky.net/forecast/023385303e6a2a3f43cf3d09fb0dab7e/'+state_info[state]['lat']+','+state_info[state]['lng'];
			var temp=0;
